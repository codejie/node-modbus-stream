...
exports.tcpSerial = {
	connect : function () {
		...
		socket.attach(exports.transports.tcpSerial.prepare({ retry: options.retry }), next);
	},
	server : function () {
		var options = {};
		var next    = noop;
		...
		return exports.drivers.tcpSerial.server(options).attach(exports.transports.tcpSerial.prepare({ retry: options.retry }), next);
	}
};
